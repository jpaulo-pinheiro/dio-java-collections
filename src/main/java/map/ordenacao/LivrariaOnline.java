...
public class LivrariaOnline {
        ...
        if (livros.isEmpty()) {
            ...
            for (Map.Entry<String, Livro> entry : livros.entrySet()) {
                ...
                if (livro.getTitulo().equals(titulo)) {
                    ...
                    throw new RuntimeException("O livro '" + titulo + " não está na livraria.");
                }
            }
        }
    ...
    public static void main(String[] args) {
        ...
        // Exibe a quantidade de livros na livraria
        System.out.println("A livraria possui " + livrariaOnline.obterQuantidadeLivros() + " livros.");
        ...
        System.out.println("Livro(s) mais caro: " + livrariaOnline.obterLivroMaisCaro());

        // Obtém e exibe o livro mais barato
        System.out.println("Livro(s) mais barato: " + livrariaOnline.obterLivroMaisBarato());
